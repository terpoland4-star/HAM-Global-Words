...
(function() {
  ...
  const translations = {
    ...
    ar: {
      ...
      expertise_desc: "تجمع HAM Global Words بين اللسانيات الميدانية والإدارة التشغيلية وتقنيات الذكاء الاصطناعي المتقدمة لتقديم حلول موثوقة وأخلاقية تتكيف مع البيئات المعقدة. قوتنا: الخبرة الميدانية مقرونة بالابتكار الرقمي.",
      exp_ia_desc: "هيكلة ووسم والتحقق من صحة البيانات متعددة اللغات لنماذج NLP والتعرف على الصوت وأنظمة الذكاء الاصطناعي. جودة مضمونة من قبل خبراء لغويين.",
      ...
      exp_ops_desc: "إدارة المشاريع اللغوية المعقدة ومراقبة الجودة والامتثال للقانون العام لحماية البيانات وتحسين الأداء لتسليمات لا تشوبها شائبة.",
      ...
      form_email: "بريدك الإلكتروني المهني",
      form_service: "اختر خدمة",
      form_message: "صف مشروعك واحتياجاتك وقيودك...",
